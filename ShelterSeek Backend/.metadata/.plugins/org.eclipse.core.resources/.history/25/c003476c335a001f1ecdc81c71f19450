...
public class PropertyController {
    ...
    public ResponseEntity<?> createProperty(@RequestBody PropertyDTO propertyDTO,@PathVariable Long ownerId) {
        try {
        	System.out.println(propertyDTO);
            PropertyDTO savedProperty = propertyService.addProperty(propertyDTO,ownerId);
